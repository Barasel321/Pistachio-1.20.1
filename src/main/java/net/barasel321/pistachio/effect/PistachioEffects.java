...
public class PistachioEffects {
    ...
    public static void registerEffects(){
        ...
        PHAGE = registerStatusEffect("phage",new PhageEffect(StatusEffectCategory.HARMFUL, 0xc722bf)).addAttributeModifier(EntityAttributes.GENERIC_MAX_HEALTH, "7104DE2E-7CE8-4031-940E-514C1F160895", -2.0f, EntityAttributeModifier.Operation.ADDITION);
